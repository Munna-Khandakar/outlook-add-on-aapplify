    ...
    return (
        <div>
            ...
            <form onSubmit={handleSubmit(onSubmit)}>
                <div className="mb-5">
                    <label htmlFor="email"
                           className={`block mb-2 text-sm font-medium ${errors.email ? 'text-red-500' : 'text-gray-900 dark:text-white'}`}>Your
                        email</label>
                    <input
                        type="email"
                        id="email"
                ...
                <div className="mb-5">
                    <label htmlFor="password"
                           className={`block mb-2 text-sm font-medium ${errors.password ? 'text-red-500' : 'text-gray-900 dark:text-white'}`}>Your
                        password</label>
                    <input
                        type="password"
                        id="password"

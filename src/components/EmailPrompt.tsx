...
export const EmailPrompt = (props: EmailPromptProps) => {
    ...
    const onSubmit: SubmitHandler<EmailPromptInput> = (data) => {
        api.post('/service-email/generate-email', data).then((response) => {
            setSuggestionsResponse(['This is a suggestion', 'This is a suggestion 2']);
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className="py-4">
            <label htmlFor="prompt" className="block mb-2 text-lg font-bold text-gray-900 dark:text-white">Your Prompt</label>
            ...
            <div className="flex justify-end">
                <div className="relative group">
                    ...
                    >
                        ...
                        <span className="relative z-10 block px-6 py-3 rounded-xl bg-gray-50 dark:bg-gray-700">
        <div className="relative z-10 flex items-center space-x-2">
          <span className="transition-all duration-500 group-hover:translate-x-1 text-sm text-gray-900 dark:text-white">Generate Email</span>
          <svg
